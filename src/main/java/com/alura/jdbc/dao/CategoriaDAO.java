...
public class CategoriaDAO {
	...
	public List<Categoria> listar() {
		...
		try {
			...
			final PreparedStatement statement = this.con.prepareStatement(querySelect);
			try (statement) {
	...
	public List<Categoria> listarConProductos() {
		List<Categoria> resultado = new ArrayList<>();
		try {
			/*var querySelect = "SELECT CATEGORIA.ID, CATEGORIA.NOMBRE, PRODUCTO.ID, PRODUCTO.NOMBRE, PRODUCTO.CANTIDAD " 
							+ "FROM CATEGORIA " 
